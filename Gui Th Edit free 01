...
local Themes = {
	...
	Ben10 = {
		...
		MaximiseAccent = Color3.fromRGB(255, 0, 0),
		NavBar = Color3.fromRGB(64,221,138),
		NavBarAccent = Color3.fromRGB(0, 0, 0),
		NavBarInvert = Color3.fromRGB(30,30,30),
		TitleBar = Color3.fromRGB(64,221,138),
		TitleBarAccent = Color3.fromRGB(0, 0, 0),
		Overlay = Color3.fromRGB(255,255,255),
		Banner = Color3.fromRGB(255,255,255),
		BannerAccent = Color3.fromRGB(64,221,138),
		Content = Color3.fromRGB(64,221,138),
		Button = Color3.fromRGB(64,221,138),
		ButtonAccent = Color3.fromRGB(255,255,255),
		ChipSet = Color3.fromRGB(64,221,138),
		ChipSetAccent = Color3.fromRGB(255,255,255),
		DataTable = Color3.fromRGB(64,221,138),
		DataTableAccent = Color3.fromRGB(255,255,255),
		Slider = Color3.fromRGB(255,255,255),
		SliderAccent = Color3.fromRGB(255,255,255),
		Toggle = Color3.fromRGB(255,255,255),
		ToggleAccent = Color3.fromRGB(255,255,255),
		Dropdown = Color3.fromRGB(64,221,138),
